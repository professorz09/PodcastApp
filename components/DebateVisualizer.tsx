                ...
                {settingsTab === 'subtitle' && (
                  <div className="space-y-4">
                    ...
                    <div className={`space-y-4 transition-opacity ${showSubtitles ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
                      <div>
                        <label className="text-[10px] text-gray-500 uppercase tracking-widest font-semibold block mb-2">Background</label>
                        <div className="flex gap-2">
                          {[
                            ...
                            <button key={opt.label}
                              ...
                              className={`flex-1 py-2 text-xs font-bold rounded-lg border-2 transition-all ${currentSubtitleConfig.backgroundColor === opt.value ? 'border-red-500 text-red-300 bg-red-500/10' : 'border-white/10 text-gray-400 hover:border-white/20'}`}
                            >{opt.label}</button>
                          ))}
                        </div>
                      </div>
