...
//
// NOTE: duplicates services/vertexProxy.ts's parseGcpServiceAccount/isValidPrivateKey
// instead of importing them — see api/gemini.ts for why (Vercel doesn't reliably
