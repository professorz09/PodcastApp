...
export interface DebateConfig {
  ...
  model: 'gemini-3.6-flash' | 'gemini-3.1-pro-preview' | 'gemini-3.1-flash-lite';
  language: string;
  style: 'debate' | 'debate2' | 'conversational' | 'formal debate' | 'explained' | 'explained_solo' | 'narration' | 'deep_explainer' | 'image' | 'podcast_breakdown' | 'podcast_panel' | 'context_bridge' | 'situational' | 'documentary' | 'joe_rogan' | 'finance_deep_dive' | 'professor_jiang' | 'book_summary' | 'questioning' | 'transcript_review' | 'summarizer_pov' | 'phone_studio';
  speakerCount: number;
