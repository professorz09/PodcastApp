          ...
          if (!includeNarrator) {
            ...
            if (includeNarrator) {
              prompt = `
                ...
                ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                OPENING — NARRATOR (sirf 2 chhoti lines):
                ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                Line 1 (1 sentence): Topic + dono debaters ke naam + unki side — sab ek hi chhoti line mein.
                Line 2 (1 sentence): Ek sharp debate question. Bas.
                STRICT: Koi 3rd line nahi. Koi explanation nahi. Total 2 sentences.
              ...
              prompt = `
                ...
                ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                OPENING — Speaker A (sirf 2 chhoti lines):
                ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                Line 1 (1 sentence): Topic + apna naam + apni side + opponent ka naam + uski side — sab ek hi chhoti line mein.
                Line 2 (1 sentence): Ek sharp debate question opponent ko throw karo. Bas.
                STRICT: Koi 3rd line nahi. Koi explanation nahi. Total 2 sentences.
        ...
        if (style === 'explained') {
          ...
          if (includeNarrator) {
            prompt = `
              ...
              ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              OPENING — NARRATOR (exactly 2 short sentences):
              ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              Sentence 1: Topic + both debaters' names + their sides — all packed into one short sentence.
              Sentence 2: One sharp debate question. Done.
              STRICT: No 3rd sentence. No filler. No build-up. 2 sentences total.
            ...
            prompt = `
              ...
              ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              OPENING — Speaker A (exactly 2 short sentences):
              ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              Sentence 1: Topic + your name + your side + opponent's name + their side — one short sentence.
              Sentence 2: One sharp debate question thrown at your opponent. Done.
              STRICT: No 3rd sentence. No filler. No build-up. 2 sentences total.
